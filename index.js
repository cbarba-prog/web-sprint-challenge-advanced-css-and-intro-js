...
function funct1(arr1, indx1, indx){

  return `${arr1[indx1].name} ${arr1[indx].bio}`
  
}

console.log(funct1(artists, 0, 2));
...
*/
function getArtistByIndex(arr3, index3) {
  return `The artist at index ${arr3[index3].id} is ${arr3[index3].name}`
  }
...
*/
console.log(artists);
function removeArtist(arr5, index5) {
...
addArtist(20, "Chris", "1992-2020", "Web Design", "US", "Web Development Full Stack, no Data Science experience");
...
function lotsOfArt(arr7){
  
  if(arr7.paintings > 100){
    return arr7
  }
}
...
<div class = "bio">Vincent Willem van Gogh (Dutch: [ˈvɪnsɛnt ˈʋɪləm vɑŋ ˈɣɔx] (listen); 30 March 1853 – 29 July 1890) 
...
They include landscapes, still lifes, portraits and self-portraits, and are characterised by bold colours and dramatic, 
impulsive and expressive brushwork that contributed to the foundations of modern art. However, he was not commercially successful, 
...
‼️ You do **NOT** need to get these to display on your page, but you can copy and paste the result into your 
HTML file if you'd like to see what that would look like. */
